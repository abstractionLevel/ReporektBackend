...
const FETCH_REPORT_TYPES_OF_PLAYER = serverProxy+"/api/v1/players/reportsType?username=";
const FETCH_ALL_REPORTS_TYPE =  serverProxy+"/api/v1/reportTypeRegion/all?region=";
