...
const API_URL_REPORT = serverProxy+"/api/v1/reports?region="+userRegion;
const API_URL_FETCH_REPORT_BY_PLAYER =  serverProxy+"/api/v1/reports/players/";
const API_URL_FETCH_LAST_REPORT_OF_REGION =  serverProxy+"/api/v1/reports/last?region="+userRegion;
